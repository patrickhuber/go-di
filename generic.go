...
func RegisterInstance[T any](container Container, instance T, options ...RegistrationOption) {
	t := reflect.TypeOf((*T)(nil)).Elem()
	container.RegisterInstance(t, instance, options...)
}

func RegisterDynamic[T any](container Container, delegate func(Resolver) (T, error), options ...RegistrationOption) {
	t := reflect.TypeOf((*T)(nil)).Elem()
